...
test("guide has verified sections, commands, and sources", () => {
  ...
  assert.ok(guide.commands.some((x) => x.command === "npx @skills-portais-orion/skills@latest"));
  assert.ok(guide.commands.some((x) => x.command === "npx @skills-portais-orion/skills@latest --skill '*' -y"));
